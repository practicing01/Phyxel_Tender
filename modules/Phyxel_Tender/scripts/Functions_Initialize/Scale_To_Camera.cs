...
%Size.X=(%Size.X*Phyxel_Tender.Resolution.X)/%Ass.Optimal_Resolution.X;

%Size.Y=(%Size.Y*Phyxel_Tender.Resolution.Y)/%Ass.Optimal_Resolution.Y;
...
%Size.X=(%Size.X*Phyxel_Tender.Camera_Size.X)/Phyxel_Tender.Resolution.X;

%Size.Y=(%Size.Y*Phyxel_Tender.Camera_Size.Y)/Phyxel_Tender.Resolution.Y;
...
%Vector_2D_Scaled.X-=Phyxel_Tender.Resolution.X/2;//offset cus cam is from -50 to 50

%Vector_2D_Scaled.Y-=Phyxel_Tender.Resolution.Y/2;//offset cus cam is from -30 to 30

%Vector_2D_Scaled.Y=-%Vector_2D_Scaled.Y;//flip cus -y is down and +y is up

%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Phyxel_Tender.Camera_Size.X)/Phyxel_Tender.Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Phyxel_Tender.Camera_Size.Y)/Phyxel_Tender.Resolution.Y;
...
%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Phyxel_Tender.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Phyxel_Tender.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Phyxel_Tender.Camera_Size.X)/Phyxel_Tender.Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Phyxel_Tender.Camera_Size.Y)/Phyxel_Tender.Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Phyxel_Tender.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Phyxel_Tender.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Phyxel_Tender.Resolution.X)/Phyxel_Tender.Camera_Size.X;

%Vector_2D.Y=(%Vector_2D.Y*Phyxel_Tender.Resolution.Y)/Phyxel_Tender.Camera_Size.Y;
